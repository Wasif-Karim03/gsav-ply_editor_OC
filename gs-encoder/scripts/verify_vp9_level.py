"""Pinpoint which VP9 option causes corruption: row-mt vs level."""
...
def main():
    ...
    _, atlas_width, atlas_height = compute_atlas_dimensions(n_gaussians)
    ...
    configs = [
        ("baseline (no extras)",       {"lossless": "1", "cpu-used": "4"}),
        ("+ row-mt only",              {"lossless": "1", "cpu-used": "4", "row-mt": "1"}),
        ("+ level 5.1 only",           {"lossless": "1", "cpu-used": "4", "level": "5.1"}),
        ("+ row-mt + level 5.1",       {"lossless": "1", "cpu-used": "4", "row-mt": "1", "level": "5.1"}),
        ("+ row-mt + level 6.0",       {"lossless": "1", "cpu-used": "4", "row-mt": "1", "level": "6.0"}),
        ("+ row-mt + level 6.2",       {"lossless": "1", "cpu-used": "4", "row-mt": "1", "level": "6.2"}),
    ]
